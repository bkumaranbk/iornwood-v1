...
const Food = () => {
  return (
    <div className="flex flex-col mb-16 items-center p-4 space-y-6">
      {/* Image */}
      <img
      ...
      {/* Title */}
      <h1 className="text-4xl font-bold text-center">Your Page Title</h1>

      {/* Description */}
      <p className="text-lg text-center max-w-screen-md">
        This is where the description goes. It can be a brief paragraph that
        provides information about the content of the page.
      </p>
